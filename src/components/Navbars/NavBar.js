						...
						<Nav navbar>
							<NavItem>
								<NavLink href='/admin/bmr'>
									...
									BMR <span className='sr-only'>(current)</span>
								</NavLink>
							</NavItem>
							<NavItem>
								<NavLink href='/admin/blog/all'>
									<i class='fab fa-blogger-b text-dark'></i>Blogs{' '}
							...
							{!this.state.user && (
								<NavItem>
									<NavLink href='/auth/register'>
										<i class='fas fa-user-plus text-dark'></i>Sign Up{' '}
										<span className='sr-only'>(current)</span>
									</NavLink>
								</NavItem>
							)}
							{!this.state.user && (
								<NavItem>
									<NavLink href='/auth/login'>
										<i class='fas fa-sign-in-alt text-dark'></i>Sign In{' '}
										<span className='sr-only'>(current)</span>
									</NavLink>
								</NavItem>
							)}
							{this.state.user && (
								<NavItem>
									<UncontrolledDropdown navbar>
										...
										<DropdownMenu right>
											<DropdownItem href='#pablo'>My Profile</DropdownItem>
											<DropdownItem href='#pablo'>Subscriptions</DropdownItem>
											<DropdownItem href='#pablo'>My Blogs</DropdownItem>
											<DropdownItem
												href='/admin/index'
												onClick={(e) => {
													Auth.signOut().then(() => {
